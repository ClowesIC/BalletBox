...
public class StraightLine extends Tetronimo
{
    ...
    public StraightLine()
    {
        ...
        super.r1.setColor(Color.CYAN);  super.r1.setFrameColor(Color.BLACK);
        super.r2.setColor(Color.CYAN);  super.r2.setFrameColor(Color.BLACK);
        super.r3.setColor(Color.CYAN);  super.r3.setFrameColor(Color.BLACK);
        super.r4.setColor(Color.CYAN);  super.r4.setFrameColor(Color.BLACK);
