...
int main() {
	...
	cout << "The following shows a matrix created using the second constructor: "
		<< endl << endl;
	cout << matA << endl << endl;
	...
	cout << "After concatenating B to the right of A. A becomes: " << endl <<
		endl;
	cout << matA << endl << endl;
	...
	cout << "The following shows a Matrix C, created from copying the Matrix B above: " << endl << endl;
		myMatrix matC(matB);
	cout << matC << endl << endl;
	cout << "Now, we make some changes to matrix C. It becomes: " << endl <<
		endl;
	matC.SetEntry(0, 1, 5);
	matC.SetEntry(2, 0, 4);
	cout << matC << endl << endl;
	...
	matD = matB;
	cout << matD << endl << endl;
	cout << "Now, we make some changes to matrix D. It becomes: " << endl <<
		endl;
	...
	cout << "Matrix A dimension: " << matA.GetHeight() << " x " <<
		matA.GetWidth() << " and ";
	cout << "Matrix B dimension: " << matB.GetHeight() << " x " <<
		matB.GetWidth() << endl;
